...
<table id="dg" class="easyui-datagrid" pagination="true" rownumbers="true"
       ...
       url="${ctx}/saleChance/querySaleChancesByParams" fit="true" toolbar="#tb">  <#--自动发送请求 url:发送请求路径(后台)-->
...
<div id="dlg" class="easyui-dialog" title="添加营销记录" closed="true"  style="width: 500px;height:300px" buttons="#bt">
...
<div id="bt">
    <a href="javascript:InsertOrUpdateSaleChance()" class="easyui-linkbutton" plain="true" iconCls="icon-save">保存</a>
