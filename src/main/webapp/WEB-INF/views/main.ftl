<html>
<head>
    <#include "common.ftl" >  <#--包含 common.ftl页面-->
...
<div id="dlg" class="easyui-dialog" style="width:400px;height:250px;padding: 10px 20px"  closed="true" buttons="#dlg-buttons" title="修改密码">
